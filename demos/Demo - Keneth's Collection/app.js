...
const BRAND_SIGNATURE_LOGO = "Logo.png?v=1773684207095";
...
const RUNTIME_GUIDANCE_ASSETS = {"circularMotionArrows":"visual_onboarding/circular_motion_arrows.png?v=1773684207095","horVerMotionArrows":"visual_onboarding/hor_ver_motion_arrows.png?v=1773684207095","horizontalMotionArrows":"visual_onboarding/horizontal_motion_arrows.png?v=1773684207095","pointingHand":"visual_onboarding/pointing_hand.png?v=1773684207095","sampleDish":"visual_onboarding/sample_2d_dish.png?v=1773684207095"};
...
const loadStartupAssetBytes = async () => {
  ...
  startupAssetBytesPromise = (async () => {
    try {
      const response = await fetch("asset-manifest.json?v=1773684207095", { cache: "force-cache" });
