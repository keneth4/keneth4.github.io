...
const BRAND_SIGNATURE_LOGO = "Logo.png?v=1773689057099";
...
const RUNTIME_GUIDANCE_ASSETS = {"circularMotionArrows":"visual_onboarding/circular_motion_arrows.png?v=1773689057099","horVerMotionArrows":"visual_onboarding/hor_ver_motion_arrows.png?v=1773689057099","horizontalMotionArrows":"visual_onboarding/horizontal_motion_arrows.png?v=1773689057099","pointingHand":"visual_onboarding/pointing_hand.png?v=1773689057099","sampleDish":"visual_onboarding/sample_2d_dish.png?v=1773689057099"};
...
const loadStartupAssetBytes = async () => {
  ...
  startupAssetBytesPromise = (async () => {
    try {
      const response = await fetch("asset-manifest.json?v=1773689057099", { cache: "force-cache" });
