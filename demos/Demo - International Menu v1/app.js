...
const BRAND_SIGNATURE_LOGO = "Logo.png?v=1773897826619";
...
const backgroundFocusStyles = ["--menu-bg-pos-portrait:70% 50%;--menu-bg-pos-wide:50% 50%;"];
...
const RUNTIME_GUIDANCE_ASSETS = {"circularMotionArrows":"visual_onboarding/circular_motion_arrows.png?v=1773897826619","horVerMotionArrows":"visual_onboarding/hor_ver_motion_arrows.png?v=1773897826619","horizontalMotionArrows":"visual_onboarding/horizontal_motion_arrows.png?v=1773897826619","pointingHand":"visual_onboarding/pointing_hand.png?v=1773897826619","sampleDish":"visual_onboarding/sample_2d_dish.png?v=1773897826619"};
...
const resolveAssetUsageDisclaimer = () => {
  ...
  const fallback =
    typeof localized[DATA.meta.defaultLocale] === "string"
      ? localized[DATA.meta.defaultLocale]
      : "";
...
const loadStartupAssetBytes = async () => {
  ...
  startupAssetBytesPromise = (async () => {
    try {
      const response = await fetch("asset-manifest.json?v=1773897826619", { cache: "force-cache" });
