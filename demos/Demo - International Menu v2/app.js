...
const BRAND_SIGNATURE_LOGO = "Logo.png?v=1773689228773";
...
const SECTION_LANE_AXIS = "horizontal";
const ITEM_LANE_AXIS = "vertical";
const WIDE_FOCUS_LAYOUT = "two-zone";
const WIDE_SECTION_PEEK_RATIO = 0.1;
const SECTION_NAV_POLICY = "desktop-only";
const SECTION_LANE_THRESHOLD_PX = 300;
const SECTION_LANE_SETTLE_MS = 170;
const SECTION_LANE_TOUCH_INTENT_THRESHOLD = 10;
const SECTION_LANE_TOUCH_DELTA_SCALE = 2.1;
...
const RUNTIME_GUIDANCE_ASSETS = {"circularMotionArrows":"visual_onboarding/circular_motion_arrows.png?v=1773689228773","horVerMotionArrows":"visual_onboarding/hor_ver_motion_arrows.png?v=1773689228773","horizontalMotionArrows":"visual_onboarding/horizontal_motion_arrows.png?v=1773689228773","pointingHand":"visual_onboarding/pointing_hand.png?v=1773689228773","sampleDish":"visual_onboarding/sample_2d_dish.png?v=1773689228773"};
...
const loadStartupAssetBytes = async () => {
  ...
  startupAssetBytesPromise = (async () => {
    try {
      const response = await fetch("asset-manifest.json?v=1773689228773", { cache: "force-cache" });
